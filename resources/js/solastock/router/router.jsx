    ...
    [
        {
            ...
            children: [
                ...
                { path: 'transfers/new', element: protectedElement(<TransferFormPage />, 'inventory.transfer_stock') },
                { path: 'transfers/:id', element: <TransferDetailPage /> },
                { path: 'transfers/:id/edit', element: protectedElement(<TransferFormPage />, 'inventory.transfer_stock') },
