    ...
    return (
        <section className="page">
            ...
            <div className="toolbar" style={{ display: 'flex', gap: 8 }}>
                <input className="input" placeholder={t('items.search')} value={search}
                    onChange={(e) => setSearch(e.target.value)} />
                <select className="input" value={type} onChange={(e) => setType(e.target.value)}>
                    <option value="">{t('items.allTypes')}</option><option value="inventory">{t('items.inventory')}</option>
                    <option value="non_inventory">{t('items.nonInventory')}</option><option value="service">{t('items.service')}</option>
                </select>
                <select className="input" value={status} onChange={(e) => setStatus(e.target.value)}>
                    <option value="">{t('items.anyStock')}</option><option value="in">{t('items.inStock')}</option>
                    <option value="low">{t('items.low')}</option><option value="out">{t('items.out')}</option>
                </select>
            </div>
