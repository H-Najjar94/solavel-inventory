    ...
    return (
        <section className="page">
            ...
            <div className="panel report-filters">
                ...
                {tab === 'audit' && <Field label={t('ledger.action')}><input className="input" value={filters.action} onChange={(e) => setFilters({ ...filters, action: e.target.value })} placeholder="item.updated" /></Field>}
                {tab === 'audit' && <Field label={t('ledger.entity')}><input className="input" value={filters.entity_type} onChange={(e) => setFilters({ ...filters, entity_type: e.target.value })} placeholder="item" /></Field>}
