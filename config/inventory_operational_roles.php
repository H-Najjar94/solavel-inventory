...
return [
    'scoped_inventory_manager' => ['label' => 'Inventory Manager', 'ar' => 'مدير المخزون', 'permissions' => array_merge($warehouse, ['inventory.view_ledger', 'inventory.view_reports', 'inventory.export_reports'])],
