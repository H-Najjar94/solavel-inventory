...
| Inventory Manager (`scoped_inventory_manager`) | Receiving, transfers, picking, packing, shipments, reservations, zones/bins, on-demand reports/exports | Assigned warehouses; scheduled reports require organization-wide authority; no global catalog edits, adjustments, settings, delegation, integration or quarantine overrides. |
