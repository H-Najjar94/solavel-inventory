...
class TenantSchemaAuditService
{
    ...
    public static function requirements(): array
    {
        return [
            ...
            'purchase_order_lines' => ['columns' => ['organization_id', 'purchase_order_id', 'item_id', 'ordered_qty', 'received_qty', 'entered_qty', 'entered_unit_id', 'base_unit_id', 'unit_conversion_id', 'unit_conversion_factor', 'unit_conversion_version', 'unit_conversion_hash', 'unit_conversion_precision', 'unit_conversion_rounding_mode', 'tax_code', 'tax_treatment', 'tax_rate', 'tax_amount', 'line_total']],
            ...
            'goods_receipt_lines' => ['columns' => ['organization_id', 'goods_receipt_id', 'item_id', 'received_qty', 'accepted_qty', 'rejected_qty', 'inspection_status', 'disposition', 'quarantine_qty', 'entered_qty', 'entered_unit_id', 'base_unit_id', 'unit_conversion_id', 'unit_conversion_factor', 'unit_conversion_version', 'unit_conversion_hash', 'unit_conversion_precision', 'unit_conversion_rounding_mode']],
            'opening_stock_entries' => ['columns' => ['organization_id', 'entry_number', 'warehouse_id', 'status', 'total_value']],
            'opening_stock_entry_lines' => ['columns' => ['organization_id', 'opening_stock_entry_id', 'item_id', 'quantity', 'unit_cost', 'entered_qty', 'entered_unit_id', 'base_unit_id', 'unit_conversion_id', 'unit_conversion_factor', 'unit_conversion_version', 'unit_conversion_hash', 'unit_conversion_precision', 'unit_conversion_rounding_mode']],
            'stock_transfers' => ['columns' => ['organization_id', 'transfer_number', 'from_warehouse_id', 'to_warehouse_id', 'status', 'shipped_at', 'received_at']],
            'stock_transfer_lines' => ['columns' => ['organization_id', 'stock_transfer_id', 'item_id', 'quantity', 'entered_qty', 'entered_unit_id', 'base_unit_id', 'unit_conversion_factor', 'unit_conversion_hash']],
            'stock_adjustments' => ['columns' => ['organization_id', 'adjustment_number', 'warehouse_id', 'status']],
            'stock_adjustment_lines' => ['columns' => ['organization_id', 'stock_adjustment_id', 'item_id', 'direction', 'quantity', 'entered_qty', 'entered_unit_id', 'base_unit_id', 'unit_conversion_factor', 'unit_conversion_hash']],
            ...
            'shipment_lines' => ['columns' => ['organization_id', 'shipment_id', 'item_id', 'quantity', 'entered_qty', 'entered_unit_id', 'base_unit_id', 'unit_conversion_factor', 'unit_conversion_hash', 'lot_id', 'serial_id']],
            ...
            'sales_return_lines' => ['columns' => ['organization_id', 'sales_return_id', 'item_id', 'returned_qty', 'entered_qty', 'entered_unit_id', 'base_unit_id', 'unit_conversion_factor', 'unit_conversion_hash', 'condition', 'inspection_status', 'disposition']],
