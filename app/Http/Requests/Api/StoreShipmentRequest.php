...
class StoreShipmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ship_to.name' => ['nullable','string','max:191'],
            'ship_to.address' => ['nullable','string','max:500'],
            'ship_to.city' => ['nullable','string','max:100'],
            'ship_to.country' => ['nullable','string','max:100'],
