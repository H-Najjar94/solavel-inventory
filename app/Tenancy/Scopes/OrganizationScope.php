...
class OrganizationScope implements Scope
{
    public function apply(Builder $builder, Model $model): void
    {
        ...
        // SolaStock operational rows are always scoped by the selected CENTRAL
        // organization id. A tenant-local Finance organizations.id is a distinct
        // identity and must never widen ordinary SolaStock reads. Historical
        // Finance/local-id records remain available only to the explicit,
        // read-only integration discovery services that reconcile those ids.
