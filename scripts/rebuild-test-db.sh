...
export DB_USERNAME="$TEST_USER" DB_PASSWORD="$TEST_PASS"
export TENANT_DB_ADMIN_USER="$TEST_USER" TENANT_DB_ADMIN_PASS="$TEST_PASS"
...
CREATE TABLE IF NOT EXISTS organizations (
  ...
  setup_status VARCHAR(32) NULL
);
ALTER TABLE organizations ADD COLUMN IF NOT EXISTS name VARCHAR(191) NULL;
ALTER TABLE organizations ADD COLUMN IF NOT EXISTS setup_status VARCHAR(32) NULL;
ALTER TABLE organizations ADD COLUMN IF NOT EXISTS finance_setup_completed_at TIMESTAMP NULL;
CREATE TABLE IF NOT EXISTS invoices (id BIGINT UNSIGNED PRIMARY KEY, organization_id BIGINT UNSIGNED NULL);
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS organization_id BIGINT UNSIGNED NULL;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS status VARCHAR(32) NULL;
ALTER TABLE organizations ADD COLUMN IF NOT EXISTS finance_setup_step VARCHAR(32) NULL;
...
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS system_key VARCHAR(100) NULL;
ALTER TABLE accounts ADD COLUMN IF NOT EXISTS account_role VARCHAR(100) NULL;
